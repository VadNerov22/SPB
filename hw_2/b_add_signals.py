...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonComboBox.clicked.connect(self.show_dialogComboBox)
        ...
        self.pushButtonPlainTextEdit.clicked.connect(self.onButtonPlainTextEditClicked)
        self.pushButtonSpinBox.clicked.connect(self.onButtonSpinBoxClicked)
        self.pushButtonDoubleSpinBox.clicked.connect(self.onButtonDoubleSpinBoxClicked)
        self.pushButtonTimeEdit.clicked.connect(self.onButtonTimeEditClicked)
        self.pushButtonDateTimeEdit.clicked.connect(self.onButtonDateTimeEdit)
        self.pushButtonClearLog.clicked.connect(self.onButtonClearLog)

        self.comboBox.currentTextChanged.connect(self.show_dialogComboBox)
        self.spinBox.valueChanged.connect(self.onButtonSpinBoxClicked)
        self.dateTimeEdit.dateTimeChanged.connect(self.onButtonDateTimeEdit)

    # slots --------------------------------------------------------------
    def show_dialogComboBox(self) -> None:
        """
    ...
    def onButtonPlainTextEditClicked(self) -> None:
        """
    ...
    def onButtonSpinBoxClicked(self) -> None:
        """
    ...
    def onButtonDoubleSpinBoxClicked(self) -> None:
        """
    ...
    def onButtonTimeEditClicked(self) -> None:
        """
    ...
    def onButtonDateTimeEdit(self) -> None:
        """
    ...
    def onButtonClearLog(self) -> None:
        """
        Обработка сигнала clicked для кнопки pushonButtonClearLog
